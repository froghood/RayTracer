...
public class ImGuiController {
    ...
    public void SetLayout(Action layout) => this.layout = layout;
    ...
    private void SetPerFrameImGuiData() {
        ...
        io.DeltaTime = Game.RenderTime.AsSeconds(); // DeltaTime is in seconds.
    }
    ...
    private void UpdateImGuiInput() {
        ...
        if (!Game.IsFocused ||
            ...
            Game.CursorState == CursorState.Hidden) return;

        ImGuiIOPtr io = ImGui.GetIO();


        KeyboardState KeyboardState = Game.Input.GetKeyboardState();

        MouseState mouseState = Game.Input.GetMouseState();
        ...
        io.MouseDelta = new System.Numerics.Vector2(mouseState.Delta.X, mouseState.Delta.Y);
